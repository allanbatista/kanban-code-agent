...
describe('SWARM_EVENT_TYPE', () => {
  it('has all event types', () => {
    ...
    expect(SWARM_EVENT_TYPE.PROJECT_CREATED).toBe('PROJECT_CREATED');
    expect(SWARM_EVENT_TYPE.PROJECT_UPDATED).toBe('PROJECT_UPDATED');
    expect(SWARM_EVENT_TYPE.PROJECT_DELETED).toBe('PROJECT_DELETED');
    expect(SWARM_EVENT_TYPE.TASK_PROJECT_LINKED).toBe('TASK_PROJECT_LINKED');
    expect(SWARM_EVENT_TYPE.WORKTREE_CREATED).toBe('WORKTREE_CREATED');
    expect(SWARM_EVENT_TYPE.COMMIT_CREATED).toBe('COMMIT_CREATED');
    expect(SWARM_EVENT_TYPE.BRANCH_MERGED).toBe('BRANCH_MERGED');
    expect(SWARM_EVENT_TYPE.MERGE_BLOCKED).toBe('MERGE_BLOCKED');
  });
});
